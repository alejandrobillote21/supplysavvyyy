          ...
          <div className="row">
            <div className="col-4">
              ...
              <address className="text-white fs-6">
                960, Aurora Boulevard, <br /> Quezon City, PH, 1109<br />
              </address>
              <a href="tel:(02) 3-438-4580" className="mt-3 d-block mb-2 text-white">
                (02) 3-438-4580
              </a>
              <a href="mailto:worldciticollegesqc.register@gmail.com" className="mt-2 d-block mb-2 text-white">
                worldciticollegesqc.register@gmail.com
              </a>
        ...
        <div className="container-xxl">
          <div className="row">
            <div className="col-12">
              <p className="text-center mb-0 text-white">&copy; {new Date().getFullYear()} Powered by Supplysavvious Group Inc.</p>
            </div>
          </div>
        </div>
      </footer>
