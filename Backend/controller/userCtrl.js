...
const getaUser = async (req, res) => {
    try {
        const { id } = req.params;
        console.log(`Received ID in controller: ${id}`);  // Debugging line
        validateMongoDbId(id);
        // Assuming you have logic to get the user here
...
const unblockUser = asyncHandler(async (req, res) => {
    ...
    const userCart = asyncHandler(async (req, res) => {
      ...
      console.log("Received data for adding to cart:", { productId, color, quantity, price, userId: _id });
    ...
    const createOrder = asyncHandler(async (req, res) => {
      ...
      try {
        ...
        // Calculate final amount based on coupon and cart total
        let finalAmount = 0;
